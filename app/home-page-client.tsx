...
import { ArrowRight, Phone, Mail, Clock, Check, Home, MapPin, Search } from "lucide-react"
                  ...
                  <div className="flex flex-col justify-center space-y-4">
                    ...
                    <div className="flex flex-col gap-2 min-[400px]:flex-row">
                      ...
                      <Button
                        size="lg"
                        variant="outline"
                        className="border-white text-white hover:bg-white/10 gap-1.5"
                        onClick={() => {
                          handleSearch("", {})
                        }}
                      >
                  ...
                  <div className="bg-white p-6 shadow-lg rounded-xl border border-gray-100">
                    <div className="space-y-4">
                      ...
                      <div className="text-center mt-2">
                        <Button variant="link" className="text-teal p-0 h-auto" onClick={() => handleSearch("", {})}>
              ...
              <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-3 md:gap-12 pt-12">
                <div className="flex flex-col items-center space-y-2 text-center">
                  ...
                  <p className="text-gray-600">
                    Every property is thoroughly vetted through the Lands Commission to eliminate fraud and ensure
                    secure transactions.
                  </p>
                </div>
                <div className="flex flex-col items-center space-y-2 text-center">
